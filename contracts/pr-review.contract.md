...
**Why it matters:** <expanded, evidence-calibrated description>
...
| comment | the `>` quote | yes | opening of the posted body |
| why | `**Why it matters:**` paragraph | yes | appended to the posted body |
